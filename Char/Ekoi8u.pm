...
This module is a run-time routines of the Char/KOI8U.pm.
Because the Char/KOI8U.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a KOI8-U string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Ekoi8u::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ekoi8u::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of KOI8-U $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Ekoi8u::fc function for case-insensitive comparisons via Char::KOI8U
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of KOI8-U $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of KOI8-U $string (or $_, if
...
=item Fold case string
  ...
  New to Char::KOI8U software, this function returns the full Unicode-like casefold of
  KOI8-U $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Ekoi8u::glob function grandfathers the use of whitespace to separate multiple
