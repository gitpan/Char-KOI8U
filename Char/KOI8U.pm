...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ekoi8u::function_ord     = 'Char::KOI8U::ord'     if /\A ord \z/oxms;
                    $Char::Ekoi8u::function_ord_    = 'Char::KOI8U::ord_'    if /\A ord \z/oxms;
                    $Char::Ekoi8u::function_reverse = 'Char::KOI8U::reverse' if /\A reverse \z/oxms;
                    $Char::Ekoi8u::function_getc    = 'Char::KOI8U::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::KOI8U::escape();
...
=head1 Calling 'Char::Ekoi8u::ignorecase()' (Char::KOI8U software provides)

Char::KOI8U software applies calling 'Char::Ekoi8u::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::KOI8U software provides)

Char::KOI8U software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::KOI8U software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::KOI8U software provides)

Char::KOI8U software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::KOI8U software and
