...
10% everything else. But this "text" means US-ASCII text, and popular KOI8-U
...
Perl3 or later can treat KOI8-U.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::KOI8U software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw KOI8-U, Doesn't use UTF8 flag like JPerl
...
It has already been achieved by KOI8-U designed for combining with
...
Contrasting is Encode module and describing "use Char::KOI8U;" on this software,
