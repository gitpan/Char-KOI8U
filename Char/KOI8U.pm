...
######################################################################
#
# Char::KOI8U - Source code filter to KOI8-U script
#
...
sub Char::KOI8U::escape_script {
    ...
    if (/^ use Char::Ekoi8u(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ekoi8u %s;\n%s", $Char::Ekoi8u::VERSION, $use_re_eval); # require run-time routines version
...
Char::KOI8U - Source code filter to escape KOI8-U

=head1 SYNOPSIS

  use Char::KOI8U;
  use Char::KOI8U version;         --- require version
