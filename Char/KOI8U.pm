...
=item * Possible to handle raw KOI8-U values

=item * Backward compatibility of data, script and how to

=item * Only Char/KOI8U.pm and Char/Ekoi8u.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Ekoi8u::lc
  lcfirst     Char::Ekoi8u::lcfirst
  uc          Char::Ekoi8u::uc
  ucfirst     Char::Ekoi8u::ucfirst
  chr         Char::Ekoi8u::chr
  glob        Char::Ekoi8u::glob
  ---------------------------------
...
Char/KOI8U.pm remove 'bytes::' at head of function name.
...
Char/KOI8U.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. KOI8-U
    +-----------------------------------+
                (No UTF8 Flag)
