...
Let's start with a bit of history: jperl 4.019+1.3 introduced KOI8-U support.
...
In this country, KOI8-U is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats KOI8-U directly, but doesn't treat
