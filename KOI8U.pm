...
=head1 Un-Escaping \ of \N, \p, \P, and \X (KOI8U software provides)

KOI8U software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (KOI8U software provide)
