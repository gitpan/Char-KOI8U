...
# eval {...} has eval "..."
if (eval { eval Char::KOI8U::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval Char::KOI8U::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval Char::KOI8U::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval Char::KOI8U::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
