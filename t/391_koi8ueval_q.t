...
if (Char::KOI8U::eval q{ Char::KOI8U::eval " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
if (Char::KOI8U::eval q{ Char::KOI8U::eval qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (Char::KOI8U::eval q{ Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return "1" } else { return "0" } }) {
...
if (Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return qq{1} } else { return qq{0} } }) {
...
if (Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return q{1} } else { return q{0} } }) {
...
my $var1 = 1;
my $var0 = 0;
if (Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return $var1 } else { return $var0 } }) {
