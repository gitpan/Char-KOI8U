...
# eval $var has eval "..."
$var = <<'END';
eval Char::KOI8U::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Char::KOI8U::escape $var) {
...
$var = <<'END';
eval Char::KOI8U::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::KOI8U::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Char::KOI8U::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Char::KOI8U::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Char::KOI8U::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::KOI8U::escape $var) {
