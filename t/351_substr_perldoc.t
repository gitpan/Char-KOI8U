...
my $color  = Char::KOI8U::substr $s, 4, 5;   # black
my $middle = Char::KOI8U::substr $s, 4, -11; # black cat climbed the
my $end    = Char::KOI8U::substr $s, 14;     # climebed the green tree
my $tail   = Char::KOI8U::substr $s, -4;     # tree
my $z      = Char::KOI8U::substr $s, -4, 2;  # tr
