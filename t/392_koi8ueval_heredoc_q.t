...
Char::KOI8U::eval " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
...
if (Char::KOI8U::eval <<'END') {
Char::KOI8U::eval qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
...
# Char::KOI8U::eval <<'END' has Char::KOI8U::eval '...'
if (Char::KOI8U::eval <<'END') {
Char::KOI8U::eval ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
...
if (Char::KOI8U::eval <<'END') {
Char::KOI8U::eval q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
